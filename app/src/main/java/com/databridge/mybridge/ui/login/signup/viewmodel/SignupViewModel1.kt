...
//
//
//class SignupViewModel1(application: Application) : BaseViewModel(application) {
//
//    internal lateinit var binder: ActivitySignupBinding
...
//        if (binder.etEmail.text.isNullOrEmpty().not() && binder.etPassword.text.isNullOrEmpty().not() && emailValidator.isValid()) {
