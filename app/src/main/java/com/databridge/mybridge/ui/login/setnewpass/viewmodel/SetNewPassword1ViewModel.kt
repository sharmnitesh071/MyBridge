...
//
//
//class SetNewPassword1ViewModel(application: Application) : BaseViewModel(application) {
//
//    internal lateinit var binder: ActivitySetNewPasswordBinding
////    lateinit var mContext: Context
//    private lateinit var loginDataModel: LoginDataModel
//
//    fun setBinder(binder: ActivitySetNewPasswordBinding) {
//        this.binder = binder
...
//        if (binder.ecConPass.text.isNullOrEmpty().not() && binder.ecPass.text.isNullOrEmpty().not() && emailValidator.isValid()) {
