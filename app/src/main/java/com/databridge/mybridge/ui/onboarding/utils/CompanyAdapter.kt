...
class CompanyAdapter(context: Context, private val dataList: ArrayList<CompanyResults>) :
    ArrayAdapter<CompanyResults>(context, android.R.layout.simple_list_item_1, dataList) {
